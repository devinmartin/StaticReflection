...
namespace StaticReflection.CodeGeneration
{
    ...
    public interface IMutatorMethodBlock<T> : IMethodBuilder<T>
    {
        /// <summary>
        ...
        IMutatorMethodBlock<T> AddReAssignmentMethodCallForMember(MemberInfo memberInfo, MethodInfo methodInfo);
        /// <summary>
        /// Adds the re assignment method call for property or field.
        /// Will take the property value, invoke the method with the property value and re-assign the response to the property
        /// </summary>
        ...
        /// <returns>A reference to this. Optionally used for fluent apis.</returns>
        IMutatorMethodBlock<T> AddReAssignmentMethodCallForMember(MemberInfo memberInfo, MethodInfo methodInfo, object methodInstance);
    }
}
